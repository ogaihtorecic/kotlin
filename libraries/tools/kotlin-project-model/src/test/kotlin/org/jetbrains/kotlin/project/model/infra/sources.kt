 ...
 * - if a given [KpmTestCase] has only one single [TestKpmGradleProject], then the project folder is omitted,
 *   and modules of that project are embedded straight into the [root]
 * - similarly, if a given [TestKpmGradleProject] has only one single [TestKpmModule], then the module folder is omitted,
...
private const val PLACEHOLDER_SOURCES_TEXT = """
/**
