...
projectTest(parallel = true, jUnitMode = JUnitMode.JUnit5, maxHeapSizeMb = 3072) {
...
projectTest("jsTest", parallel = true, jUnitMode = JUnitMode.JUnit5, maxHeapSizeMb = 3072) {
    setUpJsBoxTests(jsEnabled = true, jsIrEnabled = false)
    useJUnitPlatform()
}

projectTest("jsIrTest", true, jUnitMode = JUnitMode.JUnit5, maxHeapSizeMb = 3072) {
    setUpJsBoxTests(jsEnabled = false, jsIrEnabled = true)
    useJUnitPlatform()
}

projectTest("quickTest", parallel = true, jUnitMode = JUnitMode.JUnit5, maxHeapSizeMb = 3072) {
    setUpJsBoxTests(jsEnabled = true, jsIrEnabled = false)
